...
HMS_DB_USER = get_param('HMS_DB_USER', 'hive')
HMS_DB_PASSWORD = get_param('HMS_DB_PASSWORD', 'abc123!')
...
HMS_TRINO_USER = get_param('HMS_TRINO_USER', 'trino')
HMS_TRINO_PASSWORD = get_param('HMS_TRINO_PASSWORD', '')
...
AWS_ACCESS_KEY = get_param('AWS_ACCESS_KEY', None)
AWS_SECRET_ACCESS_KEY = get_param('AWS_SECRET_ACCESS_KEY', None)
