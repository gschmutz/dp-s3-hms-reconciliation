...
HMS_TRINO_USER = get_credential('HMS_TRINO_DB_USER', 'trino')
HMS_TRINO_PASSWORD = get_credential('HMS_TRINO_DB_PASSWORD', '')
HMS_TRINO_HOST = get_param('HMS_TRINO_DB_HOST', 'localhost')
HMS_TRINO_PORT = get_param('HMS_TRINO_DB_PORT', '28082')
HMS_TRINO_CATALOG = get_param('HMS_TRINO_CATALOG', 'minio')
HMS_TRINO_SCHEMA = get_param('HMS_TRINO_SCHEMA', 'flight_db')

TRINO_USER = get_credential('TRINO_DB_USER', 'trino')
TRINO_PASSWORD = get_credential('TRINO_DB_PASSWORD', '')
TRINO_HOST = get_param('TRINO_DB_HOST', 'localhost')
TRINO_PORT = get_param('TRINO_DB_PORT', '28082')
