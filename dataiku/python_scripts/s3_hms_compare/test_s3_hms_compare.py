...
S3_BASELINE_OBJECT_NAME = replace_vars_in_string(S3_BASELINE_OBJECT_NAME, { "admin-bucket-prefix": S3_ADMIN_BUCKET_PREFIX, "database": FILTER_DATABASE.upper(), "zone": ZONE.upper(), "env": ENV.upper() } )
